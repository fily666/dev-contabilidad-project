...
--
-- Se mantiene `security_invoker = on` aunque no haya usuarios: garantiza que la
-- vista nunca conceda mas acceso que el que tiene quien la consulta, de modo que
-- agregar una politica en el futuro no abra un hueco por la puerta de atras.
-- ============================================================================
